...
class Ui_RightColumn(object):
    def setupUi(self, RightColumn):
        ...
        self.line_edit_l_name_widget = QWidget(self.menu_2)
        self.line_edit_l_name_widget.setObjectName(u"line_edit_l_name_widget")
        self.line_edit_l_name_widget = QWidget(self.menu_2)
        self.line_edit_l_name_widget.setMinimumSize(QSize(0, 40))
        self.line_edit_l_name_widget.setMaximumSize(QSize(16777215, 40))
        self.line_edit_l_name_layout = QVBoxLayout(self.line_edit_l_name_widget)
        self.line_edit_l_name_layout.setSpacing(0)
        self.line_edit_l_name_layout.setObjectName(u"line_edit_l_name_layout")
        self.line_edit_l_name_layout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.addWidget(self.line_edit_l_name_widget)

        self.line_edit_name_widget = QWidget(self.menu_2)
        self.line_edit_name_widget.setObjectName(u"line_edit_name_widget")
        self.line_edit_name_widget = QWidget(self.menu_2)
        self.line_edit_name_widget = QWidget(self.menu_2)
        self.line_edit_name_widget.setMinimumSize(QSize(0, 40))
        self.line_edit_name_widget.setMaximumSize(QSize(16777215, 40))
        self.line_edit_name_layout = QVBoxLayout(self.line_edit_name_widget)
        self.line_edit_name_layout.setSpacing(0)
        self.line_edit_name_layout.setObjectName(u"line_edit_name_layout")
        self.line_edit_name_layout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.addWidget(self.line_edit_name_widget)

        self.line_edit_login_widget = QWidget(self.menu_2)
        self.line_edit_login_widget.setObjectName(u"line_edit_login_widget")
        self.line_edit_login_widget = QWidget(self.menu_2)
        self.line_edit_login_widget.setMinimumSize(QSize(0, 40))
        self.line_edit_login_widget.setMaximumSize(QSize(16777215, 40))
        self.line_edit_login_layout = QVBoxLayout(self.line_edit_login_widget)
        self.line_edit_login_layout.setSpacing(0)
        self.line_edit_login_layout.setObjectName(u"line_edit_login_layout")
        self.line_edit_login_layout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.addWidget(self.line_edit_login_widget)
